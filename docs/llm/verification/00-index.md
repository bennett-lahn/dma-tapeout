...
M5 `COV-*` (functional coverage point IDs) closure regenerated 2026-08-25: merge `closed=true` (`missing={}`; reviewer `tb-closure-2026-08-25`; artifact `test/runs/m5_coverage_closure.json`). Owning catalog: `08-stimulus-and-coverage.md`.
