...
- 2026-08-21 read-only review catalog: `../review-passthrough-2026-08-21/00-index.md` (RTL / testbench / firmware findings with Problem, Scope, Acceptance; merge re-recorded `closed=false`)
